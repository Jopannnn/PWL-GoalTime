    ...
    <div class="foto-lapangan-futsal">
        ...
        <div class="baris-1 reveal">
            ...
            <div class="lapangan-1">
                ...
                <div class="bagian-tombol-pesan">
                    ...
                    <a href="../../description/pages/description.php?id=10">
            ...
            <div class="lapangan-1">
                ...
                <div class="bagian-tombol-pesan">
                    <hr style="width: 380px; border: 3px solid rgb(255, 111, 0); border-radius: 40px;">
                    <a href="../../description/pages/description.php?id=11">
                        <div class="tombol-pesan" style="margin-top: 15px;">
                            <h1>Pesan</h1>
                        </div>
                    </a>
            ...
            <div class="lapangan-1">
                ...
                <div class="bagian-tombol-pesan">
                    <hr style="width: 380px; border: 3px solid rgb(255, 111, 0); border-radius: 40px;">
                    <a href="../../description/pages/description.php?id=12">
                        <div class="tombol-pesan" style="margin-top: 15px;">
                            <h1>Pesan</h1>
                        </div>
                    </a>
        ...
        <div class="baris-1">
            ...
            <div class="lapangan-1">
                ...
                <div class="bagian-tombol-pesan">
                    <hr style="width: 380px; border: 3px solid rgb(255, 111, 0); border-radius: 40px;">
                    <a href="../../description/pages/description.php?id=13">
                        <div class="tombol-pesan" style="margin-top: 15px;">
                            <h1>Pesan</h1>
                        </div>
                    </a>
            ...
            <div class="lapangan-1">
                ...
                <div class="bagian-tombol-pesan">
                    <hr style="width: 380px; border: 3px solid rgb(255, 111, 0); border-radius: 40px;">
                    <a href="../../description/pages/description.php?id=14">
                        <div class="tombol-pesan" style="margin-top: 15px;">
                            <h1>Pesan</h1>
                        </div>
                    </a>
            ...
            <div class="lapangan-1">
                ...
                <div class="bagian-tombol-pesan">
                    <hr style="width: 380px; border: 3px solid rgb(255, 111, 0); border-radius: 40px;">
                    <a href="../../description/pages/description.php?id=15">
                        <div class="tombol-pesan" style="margin-top: 15px;">
                            <h1>Pesan</h1>
                        </div>
                    </a>
